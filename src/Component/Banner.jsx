            ...
            <div className='flex pt-6 items-center justify-between'>
                ...
                <div className='w-131.5'>
                    <div className='pb-12.75'>
                        ...
                        <p className='font-Lato font-normal text-[20px] leading-7.5 text-BodyText pt-9.25'>Boost Productivity and Wellness in Your Organization with
                    ...
                    <div className='flex gap-5'>
                        ...
                        <div className='flex gap-3 px-6.25 pt-3.5 pb-3.75 rounded-[5px] border-2 border-Primary01 hover:bg-Primary01 hover:text-white animate-pulse'>
                            <div>
