      ...
      <Container>
        <div className='flex justify-between items-center'>
          <div>
            ...
            <a className='px-6.25 py-[14.5px] bg-BackgroundColor01 text-Primary01 rounded-[5px] font-Lato font-semibold text-[16px] hover:shadow-2xl transition duration-300' href="">Learn More</a>
          </div>
          <div>
